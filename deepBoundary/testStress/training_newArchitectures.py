...
net = {'Neurons': [300, 300, 300], 'activations': ['tanh'] + 2*['swish'] + ['linear'], 'lr': 5.0e-4, 'decay' : 0.2, 'drps' : [0.0] + 3*[0.005] + [0.0], 'reg' : 1.0e-8}
...
net['nsVal'] = int(5120)
net['stepEpochs'] = 1
net['file_weights'] = './models/newArchitectures/new5/weights_ny{0}_arch{1}.hdf5'.format(Nrb,archId)
net['file_net'] = './models/newArchitectures/new5/net_ny{0}_arch{1}.txt'.format(Nrb,archId)
net['file_prediction'] = './models/newArchitectures/new5/prediction_ny{0}_arch{1}.txt'.format(Nrb,archId)
