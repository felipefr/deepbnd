...
folder = "/Users/felipefr/EPFL/newDLPDES/DATA/deepBoundary/comparisonDNNvsDNS/coarseP1/"
...
for seed in range(5):
    ...
    for offset in range(maxOffset+1):
        ...
        ellipseData_ref = ellipseData[:NL]
        ...
        meshRed = feut.getMesh(meshGMSHred, 'reduced_toGenerate{0}'.format(seed), radFile, createMesh)
