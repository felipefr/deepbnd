...
EpsFluc = np.loadtxt(folder + 'Eps{0}.txt'.format(BCtest)) # this is important to set the correct macroscopic in the smaller window
StressList = np.loadtxt(folder + 'sigmaList.txt') # this is just to compare
