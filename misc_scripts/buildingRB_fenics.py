...
def youngPoisson2lame_minmax(nu_min,nu_max,E_min,E_max):
    ...
    lamb1, mu1 = youngPoisson2lame(nu_min,E_min)
    lamb2, mu2 = youngPoisson2lame(nu_min,E_max)
    lamb3, mu3 = youngPoisson2lame(nu_max,E_min)
    lamb4, mu4 = youngPoisson2lame(nu_max,E_max)
...
np.savetxt(folder + "nodes.txt", fespace.mesh().coordinates())
