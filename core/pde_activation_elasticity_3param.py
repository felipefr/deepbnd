...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 29 23:01:39 2020
...
class PDE_activation:
    ...
    def pde_mu_solver( self, _computed_mu ):
        ...
        for iQ in range(n_affine_components - 2):
            iQa = iQ
            imu = self.M_mu_map[iQ]
