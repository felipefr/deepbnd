...
if __name__ == '__main__': 
    ...
    folder = "/home/felipe/deepBND/DATA/ellipses/dataset_cluster/"
    folder_mesh = "/home/felipe/deepBND/DATA/ellipses/dataset/"
    ...
    if(op==0):
        ...
        # createXY(nameParamRVEdataset, nameYlist, nameXYlist, id_feature = 4,
        #          transformX = lambda x: np.array([transformQuadrant(xi) for xi in x.flatten()]).reshape(x.shape))
        
        createXY(nameParamRVEdataset, nameYlist, nameXYlist, id_feature = 4,
                 transformX = mapSinusCosinus)
