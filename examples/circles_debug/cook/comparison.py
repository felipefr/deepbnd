...
folder = rootDataPath + '/DEBUG/cook/meshes_seed%d/'
folderCook = rootDataPath + '/DEBUG/cook/'

cases = ['per', 'dnn', 'dnn_ref', 'dnn_ref_new_script', 'dnn_new_script', 'lin', 'full']
...
tangentName = folderCook + 'tangents_{0}.hd5'
tangents = {}
for case in cases:
...
for case in cases[:-1]:
    print(case, np.mean(errors[case]))
