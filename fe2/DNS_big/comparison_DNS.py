...
solutions = [ 'barMacro_DNS_P2_interp_ny{0}.xdmf'.format(Ny_mesh), 'multiscale{0}/barMacro_Multiscale_dnn_ny{1}.xdmf'.format(jump,Ny_mesh), 
          'multiscale{0}/barMacro_Multiscale_reduced_per_ny{1}.xdmf'.format(jump,Ny_mesh), 
...
suptitle = 'Error_DNS_24_bar_ny{1}_vs_DNS{0}'.format(jump,Ny_mesh) 
...
suptitle = 'Error_DNS_24_rel_nyMesh{1}_vs_DNS{0}'.format(jump, Ny_mesh) 
