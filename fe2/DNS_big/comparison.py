...
tangent_labels = ['DNS', 'dnn', 'reduced_per', 'full_per']
# solutions = [ 'barMacro_DNS_P2.xdmf', 'multiscale/barMacro_Multiscale_dnn_ny24.xdmf', 
#           'multiscale/barMacro_Multiscale_full_per_ny24.xdmf', 'multiscale/barMacro_Multiscale_reduced_per_ny24.xdmf'] 
solutions = [ 'multiscale{0}/barMacro_Multiscale_full_per_ny24.xdmf'.format(jump), 'multiscale{0}/barMacro_Multiscale_dnn_ny24.xdmf'.format(jump), 
          'multiscale{0}/barMacro_Multiscale_reduced_per_ny24.xdmf'.format(jump), 'multiscale{0}/barMacro_Multiscale_full_per_ny24.xdmf'.format(jump)] # temporary
         
solutions = [folder + f for f in solutions]

meshDNSfile =  folder + 'mesh.xdmf'
meshMultiscaleFile = folder + 'multiscale{0}/meshBarMacro_Multiscale_ny24.xdmf'.format(jump)
...
suptitle = 'Error_bar_ny24_vs_fullPer{0}'.format(jump) 
