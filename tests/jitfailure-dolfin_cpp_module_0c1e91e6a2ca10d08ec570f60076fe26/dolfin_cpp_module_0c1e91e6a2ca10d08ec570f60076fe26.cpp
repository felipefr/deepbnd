...
class myCoeff : public dolfin::Expression {
  public:
    ...
    myCoeff(npArray c, npArrayInt mat, int nc) : dolfin::Expression(), coeffs(c), materials(mat), ncoeff(nc) { }
...
PYBIND11_MODULE(dolfin_cpp_module_0c1e91e6a2ca10d08ec570f60076fe26, m) {
