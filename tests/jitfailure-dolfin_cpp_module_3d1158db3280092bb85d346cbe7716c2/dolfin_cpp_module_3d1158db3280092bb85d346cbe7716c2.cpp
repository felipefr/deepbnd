...
class myCoeff : public dolfin::Expression {
  public:
    ...
    npArray const coeffs; // dynamic double vector
    npArrayInt const materials; // dynamic integer vector
...
PYBIND11_MODULE(dolfin_cpp_module_3d1158db3280092bb85d346cbe7716c2, m) {
