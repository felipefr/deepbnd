...
for offset in range(1,maxOffset):
    np.savetxt('SigmaListL_' + str(offset) + '.txt', SigmaListL[:,offset-1,:])
    np.savetxt('SigmaList_' + str(offset) + '.txt', SigmaList[:,offset-1,:])
    np.savetxt('uBoundList_' + str(offset) + '.txt', uBoundList[:,offset-1,:])
