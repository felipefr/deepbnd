...
net['nsVal'] = int(5120)
net['stepEpochs'] = 1
net['file_weights'] = './models/newArchitectures/new4/weights_ny{0}_arch{1}.hdf5'.format(Nrb,archId)
net['file_net'] = './models/newArchitectures/new4/net_ny{0}_arch{1}.txt'.format(Nrb,archId)
net['file_prediction'] = './models/newArchitectures/new4/prediction_ny{0}_arch{1}.txt'.format(Nrb,archId)
