...
np.savetxt('randomIndicesTest_shear.txt', randInd)

os.system('rm sigma_prediction_ny{0}_shear.hd5'.format(Nrb))
fields, f = myhd.zeros_openFile('sigma_prediction_ny{0}_shear.hd5'.format(Nrb),
