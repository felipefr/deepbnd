...
os.system('rm sigma_prediction_ny{0}_{1}_200.hd5'.format(Nrb,typeModel))
fields, f = myhd.zeros_openFile('sigma_prediction_ny{0}_{1}_200.hd5'.format(Nrb,typeModel),
