...
np.savetxt('randomIndicesTest_200_seed1_vert.txt', randInd)

os.system('rm sigma_prediction_ny{0}_{1}_200_justTestBugTensorFlow.hd5'.format(Nrb,typeModel))
fields, f = myhd.zeros_openFile('sigma_prediction_ny{0}_{1}_200_justTestBugTensorFlow.hd5'.format(Nrb,typeModel),
